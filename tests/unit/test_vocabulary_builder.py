...
class TestVocabularyBuilder:
    ...
    def test_merge_vocabularies(self):
        ...
        vocab1 = {"marxism": {"terms": ["class struggle", "proletariat"], "score": 0.8}}
        vocab2 = {
...
class TestIntegration:
    ...
    def test_full_pipeline_with_vocabulary(self, tmp_path):
        ...
        threads = [
            {
                "thread_id": "1",
                "smushed_text": "The dictatorship of the proletariat is necessary for the transition to communism.",
            },
            {
                "thread_id": "2",
                "smushed_text": "Dialectical materialism provides the philosophical foundation for revolutionary praxis.",
            },
        ]
    ...
    def test_backwards_compatibility(self):
        ...
        themes, confidence = classifier.classify_thread(
            {"smushed_text": "Some political text"}
        )
