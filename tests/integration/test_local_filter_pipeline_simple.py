    ...
    def test_identifies_threads(self, tmp_path):
        ...
        archive = self._create_test_archive(
            ...
            [
                ...
                {
                    "id_str": "2",
                    "full_text": "Reply tweet " + "x" * 100,
                    "in_reply_to_status_id_str": "1",
                },
                {
                    "id_str": "3",
                    "full_text": "Another reply " + "x" * 100,
    ...
    def test_filters_out_noise(self, tmp_path):
        ...
        archive = self._create_test_archive(
            ...
            [
                ...
                {
                    "id_str": "1",
                    "full_text": "Long thoughtful tweet about philosophy " + "x" * 80,
                },
                {
                    "id_str": "2",
                    "full_text": "Continuing the discussion " + "x" * 100,
                    "in_reply_to_status_id_str": "1",
                },
                # Noise to filter out
                {
                    "id_str": "3",
                    "full_text": "RT @someone: check this out",
                },  # Too short
                {"id_str": "4", "full_text": "lol"},  # Too short
                {
                    "id_str": "5",
                    "full_text": "Random long tweet with no replies " + "x" * 100,
                },  # No thread
            ],
        )
