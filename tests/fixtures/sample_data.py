...
SAMPLE_SHORT_THREAD_DATA = {
    ...
    "tweet_ids": ["1733058932123456789", "1733058934125567890", "1733058936127678901"],
}
...
SAMPLE_FILTERED_THREADS = {
    "metadata": {
        "total_tweets": 21723,
        "filtered_threads": 3,
        "filter_criteria": {"min_word_count": 40, "min_tweet_count": 3},
...
FILENAME_GENERATION_CASES = [
    (
        1,
        "Wed Nov 15 14:23:45 +0000 2023",
        "The fundamental misunderstanding of dialectical materialism",
        "001-20231115-The_fundamental_misunderstanding_of_dialectical.md",
    ),
    (
        59,
        "Fri Sep 06 18:07:59 +0000 2024",
        "I have been asked by multiple comrades to comment",
        "059-20240906-I_have_been_asked_by_multiple_comrades_to_comment.md",
    ),
    (
        100,
        "Mon Jan 22 16:47:12 +0000 2024",
        "Palestine: A Case Study in Settler Colonialism",
...
TEXT_PROCESSING_EDGE_CASES = [
    ...
    (
        "A very long title that exceeds the maximum length limit and should be truncated properly at word boundaries",
        "A very long title that exceeds the maximum length",
    ),  # Long title
    (
        "Text with @mentions and #hashtags and URLs https://example.com",
        "Text with mentions and hashtags and URLs",
    ...
    (
        "Text with LOTS of CAPS and exclamation points!!!",
        "Text with LOTS of CAPS and exclamation points",
...
YAML_ESCAPING_CASES = [
    ...
    (
        'Title with "quotes"',
        "\"Title with 'quotes'\"",
    ),  # Now replaces inner double quotes with single
...
def create_mock_twitter_data(num_threads: int = 3) -> List[Dict[str, Any]]:
    ...
    for i in range(num_threads):
        ...
        thread = {
            ...
            "smushed_text": f"This is test thread number {i + 1}. "
            * (50 + i * 10),  # Variable length
