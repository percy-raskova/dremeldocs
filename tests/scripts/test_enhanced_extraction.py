...
from text_utilities import extract_entities, extract_entities_basic
...
def test_enhanced_extraction():
    ...
    for i, thread in enumerate(heavy_threads, 1):
        ...
        try:
            ...
            domain_categories = extractor.domain_vocab.get_domain_categories(
                thread["smushed_text"]
            )
            ...
            domain_count = extractor.domain_vocab.count_domain_terms(
                thread["smushed_text"]
            )
